	...
	<body bgcolor="#F5F5F5">
		<div id="site">
			...
			<div id="main">
					...
					<br/><br/>
					<div class="text6">
						<span>С детсва интересуюсь футболом. Болею за футбольный клуб Реал мадрид. Нравится создавать 3d модели. 
Занимаюсь интерьером и эксетрьером. Работаю в adobe flash.</span>
					</div>
			</div>
